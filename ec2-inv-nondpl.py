...
print ("Name,Purpose,Authorization,Backups,LaunchTime,InstanceId,InstanceType,State,PublicIP,PrivateIP" , file = log)
...
for instance in all_instances:
    ...
    print (name,pup,aut,bac,LaunchTime,Id,Type,State,PublicIP,PrivateIP , file=log)
    #print (name,pup,aut,bac,LaunchTime,Id,Type,State,PublicIP,PrivateIP , file=log)
...
for cluster in cluster_details:
    ...
    print (cluster_id,pup,aut , file=log)
...
for b in  buckets['Buckets']:
    ...
    #print output to csv file 
    bucketname += " ,"
    print (bucketname,pup,phi,aut,ctime , file=log)
